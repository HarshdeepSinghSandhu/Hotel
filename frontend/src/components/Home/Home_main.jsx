    ...
    <div className='w-full md:w-[80%] lg:w-[60%] px-10 md:px-12 lg:pl-48 z-10 text-white'>
      <div className='flex flex-col justify-center'>
        ...
        <h2 className='text-white font-raleway text-sm md:text-md lg:text-lg md:pr-10 lg:pr-28 mb-8 md:mb-10'>
          Escape to luxury at Sunset Bay Resort, where comfort meets elegance! Nestled along the pristine shores, our resort offers stunning ocean views, world-class amenities, and personalized service.
        </h2>
